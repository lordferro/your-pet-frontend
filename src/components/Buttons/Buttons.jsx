    ...
    return (
      <div className={css['btn-group']}>
         ...
         <div className={css.buttons}>
            ...
            {isLoggedIn && <div className={css['btn-auth']}>
         ...
         <div className={css['sub-buttons']}>
            ...
            <button type="button" className={css['btn-mob-filter']} onClick={handleFilterClick}><span className={css['icon-filter']}><Filter /></span></button> 
         ...
         {filterOpen && (<div className={css['filter-menu']} >
            ...
            <div className={css['age-menu']}>
               ...
               {menuAgeOpen && <div className={css.form}>
                   <div className={css.age}>
                      <input className={css.input} type="checkbox" name="age" value="age" id="0" />
                      <label className={css.label} for="age"> <span className={css['icon-check']}><Tick/></span> 3-12 m</label>
                   </div>
                   
                   <div className={css.age}>
                      <input className={css.input} type="checkbox" name="age" value="age" id="1" />
                      <label className={css.label} for="age"><span className={css['icon-check']}><Tick/></span> up to 1 year</label>
                   </div>
                   
                   <div className={css.age}>
                      <input className={css.input} type="checkbox" name="age" value="age" id="2" />
                      <label className={css.label} for="age"><span className={css['icon-check']}><Tick/></span> up to 2 year</label>
                   </div>
               </div>}
            </div>
            ...
            <div className={css['gender-menu']}>
               ...
               {menuGenderOpen && <div className={css.form}>
                   <div className={css.gender}>
                      <input className={css.input} type="checkbox" name="gender" value="gender" id="female" />
                      <label className={css.label} for="gender"><span className={css['icon-check']}><Tick/></span> female</label>
                   </div>
                   
                   <div className={css.gender}>
                      <input className={css.input} type="checkbox" name="gender" value="gender" id="male" />
                      <label className={css.label} for="gender"><span className={css['icon-check']}><Tick/></span> male</label>
                   </div>
